...
- One-click and `Control-Option-S` arrangement for eligible windows on the current desktop.
- Adaptive, non-overlapping layouts with independent multi-display handling.
- Safe matching across Core Graphics and Accessibility window records.
- Frame verification, one bounded repair pass, and Undo.
